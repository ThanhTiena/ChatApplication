...
//        User user1 = userService.getUserExistedByUserName("danh");
//        User user2 = userService.getUserExistedByUserName("tien");
//        User user3 = new User("Tin", "Nguyen", "tin", BryctEncoder.hashPassword("123456"), Gender.MALE, new Date());
//        Group group = groupService.createGroup(user1,"Test Public Group Chat","PUBLIC_GROUP");
//        Boolean result1 = groupService.sendInvitation(user1,user2,group.getGroupId());
//
//        assertTrue(result1);
//    }
    ...
    public void getGroupsOfUserTest() throws GroupException {
        ...
        assertEquals(group.getGroupId(),groupList.get(0));
    ...
    public void getContactsOfUserTest() throws GroupException {
        ...
        assertEquals(message.getMessageId(),messageList.get(0));
        assertNotEquals("Hi Long",messageList.get(0));
    }
    ...
    public void getConversationsTest() throws GroupException {
        ...
        assertEquals(message.getMessageId(),conservations.get(1));
        assertNotEquals("101",conservations.get(1));
    }
